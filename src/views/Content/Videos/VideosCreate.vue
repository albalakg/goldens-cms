...
import {VIDEO_NAME_MESSAGE, VIDEO_DESCRIPTION_MESSAGE, VIDEO_FILE_SIZE_MESSAGE, VIDEO_FILE_TYPES_MESSAGE} from './../../../helpers/Messages' 
...
export default {
    ...
    data() {
        return {
            ...
            errors: null,
            rules: {
                name: v => VIDEO_NAME_RULE.test(v) || VIDEO_NAME_MESSAGE,
                description: v => VIDEO_DESCRIPTION_RULE.test(v) || VIDEO_DESCRIPTION_MESSAGE,
            },
        }
    },
