            ...
            this.$store.dispatch('TrainingOptionState/createTrainingOption', this.form)
                .then(() => {
                    this.$store.dispatch('MessageState/addMessage', {
                        message: `Training Option ${this.form.name} created successfully`
                    });
                ...
                .catch(err => {
                    ...
                    this.$store.dispatch('MessageState/addMessage', {
                        message: 'Failed to create the Training Option',
                        type: 'error',
                    });
                })
                .finally(() => {
