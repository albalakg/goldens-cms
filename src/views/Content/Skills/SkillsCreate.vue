                ...
                >
                    <template slot="content">
                        <div class="px-4">
                            ...
                            ></v-file-input>
                            <img class="preview_skill" :src="skillSrc" />
                        </div>
                    </template>
                </FormCard>
            </v-flex>
...
export default {
    ...
    methods: {
        submit() {
            ...
            this.loading = true;
            this.$store.dispatch('SkillState/createSkill', {...this.form, image: this.file})
                .then(() => {
                    this.$store.dispatch('MessageState/addMessage', {
                        message: `Skill ${this.form.name} created successfully`
                    });
