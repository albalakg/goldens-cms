...
import {NAME_RULE, DESCRIPTION_RULE, ID_RULE, PRICE_RULE, COURSE_DISCOUNT_RULE, TRAILER_FILE_SIZE_RULE, VIDEO_FILE_TYPES_RULE, IMAGE_FILE_TYPES_RULE, IMAGE_FILE_SIZE_RULE} from '../../helpers/Rules' 
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                ...
                discount:       v => COURSE_DISCOUNT_RULE.test(v)   || DISCOUNT_MESSAGE,
            },
    ...
    computed: {
        ...
        imageSrc() {
            return this.image ? URL.createObjectURL(this.image) : this.course.imageSrc;
        },

        trailerSrc() {
            return this.trailer ? URL.createObjectURL(this.trailer) : this.course.trailerSrc;
        },
    },
    ...
    methods: {
        submit() {
            ...
            this.loading = true;
            this.$store.dispatch('CourseState/updateCourse', {...this.form, image: this.image, trailer: this.trailer})
                .then(res => {
                    this.$store.dispatch('MessageState/addMessage', {
                        message: `Course ${this.form.name} updated successfully`
                    });
